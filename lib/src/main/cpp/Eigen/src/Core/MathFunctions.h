...
****************************************************************************/
        ...
        namespace std_fallback {
            ...
            log1p(const Scalar &x) {
                ...
                return numext::equal_strict(x1p, Scalar(1)) ? x : x * (log(x1p) /
                                                                       (x1p - RealScalar(1)));
            }
        }
...
****************************************************************************/
        ...
        struct random_default_impl<Scalar, false, true> {
            static inline Scalar run(const Scalar &x, const Scalar &y) {
                ...
                typedef typename conditional<(ScalarU(-1) >
                                              unsigned(-1)), ScalarU, unsigned>::type ScalarX;
            ...
            static inline Scalar run() {
                ...
                enum {
                    ...
                    offset = NumTraits<Scalar>::IsSigned ? (1
                            << (EIGEN_PLAIN_ENUM_MIN(rand_bits, scalar_bits) - 1)) : 0
                };
...
inline int log2(int x) {
    eigen_assert(x >= 0);
    unsigned int v(x);
    static const int table[32] = {0, 9, 1, 10, 13, 21, 2, 29, 11, 14, 16, 18, 22, 25, 3, 30, 8, 12,
