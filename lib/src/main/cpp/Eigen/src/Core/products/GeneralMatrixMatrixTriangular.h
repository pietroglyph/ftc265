...
// as usual if the result is row major => we transpose the product
        ...
        struct general_matrix_matrix_triangular_product<Index, LhsScalar, LhsStorageOrder, ConjugateLhs, RhsScalar, RhsStorageOrder, ConjugateRhs, RowMajor, ResInnerStride, UpLo, Version> {
            ...
            run(Index size, Index depth, const LhsScalar *lhs, Index lhsStride,
                ...
                ::run(size, depth, rhs, rhsStride, lhs, lhsStride, res, resIncr, resStride, alpha,
                      blocking);
            }
        };
...
//   triangular traversal.
        ...
        struct tribb_kernel {
            ...
            enum {
                BlockSize = meta_least_common_multiple<EIGEN_PLAIN_ENUM_MAX(mr,
                                                                            nr), EIGEN_PLAIN_ENUM_MIN(
                        mr, nr)>::ret
            };

            void
            operator()(ResScalar *_res, Index resIncr, Index resStride, const LhsScalar *blockA,
...
// high level API
    ...
    struct general_product_to_triangular_selector<MatrixType, ProductType, UpLo, false> {
        ...
        run(MatrixType &mat, const ProductType &prod, const typename MatrixType::Scalar &alpha,
            ...
            internal::general_matrix_matrix_triangular_product<Index,
                    typename Lhs::Scalar, LhsIsRowMajor ? RowMajor
                                                        : ColMajor, LhsBlasTraits::NeedToConjugate,
                    typename Rhs::Scalar, RhsIsRowMajor ? RowMajor
    ...
    TriangularViewImpl<MatrixType, UpLo, Dense>::_assignProduct(const ProductType &prod,
        ...
        EIGEN_STATIC_ASSERT((UpLo & UnitDiag) == 0,
        ...
        general_product_to_triangular_selector<MatrixType, ProductType, UpLo,
                ...
                derived().nestedExpression().const_cast_derived(), prod, alpha, beta);
