        ...
        struct triangular_solve_matrix<Scalar, Index, Side, Mode, Conjugate, TriStorageOrder, RowMajor, OtherInnerStride> {
            static void run(
                ...
                triangular_solve_matrix<
                        ...
                        TriStorageOrder == RowMajor ? ColMajor
                                                    : RowMajor, ColMajor, OtherInnerStride>
            ...
            for (Index k2 = IsLower ? 0 : size;
                ...
                for (Index j2 = 0; j2 < cols; j2 += subcols) {
                    ...
                    for (Index k1 = 0; k1 < actual_kc; k1 += SmallPanelWidth) {
                        ...
                        for (Index k = 0; k < actualPanelWidth; ++k) {
                            ...
                            for (Index j = j2; j < j2 + actual_cols; ++j) {
                                if (TriStorageOrder == RowMajor) {
                                    ...
                                    typename OtherMapper::LinearMapper r = other.getLinearMapper(s,
                                                                                                 j);
                        ...
                        // GEBP
                        if (lengthTarget > 0) {
                            Index startTarget = IsLower ? k2 + k1 + actualPanelWidth : k2 -
                                                                                       actual_kc;
                ...
                for (Index i2 = 0; i2 < rows; i2 += mc) {
                    ...
                    // triangular solver kernel
                    {
                        ...
                        for (Index j2 = IsLower
                                        ? (actual_kc - ((actual_kc % SmallPanelWidth) ? Index(
                            ...
                            for (Index k = 0; k < actualPanelWidth; ++k) {
                                ...
                                for (Index k3 = 0; k3 < k; ++k3) {
                                    ...
                                    typename LhsMapper::LinearMapper a = lhs.getLinearMapper(i2,
                                                                                             IsLower
                                                                                             ? j +
                                                                                               1 +
                                                                                               k3 :
