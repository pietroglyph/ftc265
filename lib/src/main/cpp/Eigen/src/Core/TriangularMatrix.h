...
public:
    ...
    operator=(
            const TriangularViewImpl &other) { return *this = other.derived().nestedExpression(); }
...
/** \internal Specialization of the dense assignment kernel for triangular matrices.
  ...
  */
    ...
    public:
        ...
        EIGEN_DEVICE_FUNC
        triangular_dense_assignment_kernel(DstEvaluatorType &dst, const SrcEvaluatorType &src,
        ...
        enum {
            unroll = DstXprType::SizeAtCompileTime != Dynamic
                     ...
                     && DstXprType::SizeAtCompileTime *
                        (DstEvaluatorType::CoeffReadCost + SrcEvaluatorType::CoeffReadCost) / 2 <=
    ...
    struct Assignment<DstXprType, SrcXprType, Functor, Triangular2Dense> {
        EIGEN_DEVICE_FUNC static void
        run(DstXprType &dst, const SrcXprType &src, const Functor &func) {
            call_triangular_assignment_loop < SrcXprType::Mode, (SrcXprType::Mode & SelfAdjoint) ==
                    0 > (dst, src, func);
        }
    };
...
void TriangularBase<Derived>::evalToLazy(MatrixBase <DenseDerived> &other) const {
    ...
    internal::call_triangular_assignment_loop < Derived::Mode, (Derived::Mode & SelfAdjoint) ==
            0 /* SetOpposite */> (other.derived(), derived().nestedExpression());
}
