        ...
        public:
            ...
            enum {
                ...
                TrOptions = RowsAtCompileTime == 1 ? (MatrixType::Options & ~(RowMajor))
                                                   : ColsAtCompileTime == 1 ? (MatrixType::Options |
                                                                               RowMajor)
                                                                            : MatrixType::Options
            };
 ...
 ***/
        ...
        struct svd_precondition_2x2_block_to_be_real<MatrixType, QRPreconditioner, false> {
            ...
            static bool
            run(typename SVD::WorkMatrixType &, SVD &, Index, Index, RealScalar &) { return true; }
        };
        ...
        struct svd_precondition_2x2_block_to_be_real<MatrixType, QRPreconditioner, true> {
            ...
            static bool run(typename SVD::WorkMatrixType &work_matrix, SVD &svd, Index p, Index q,
                ...
                maxDiagEntry = numext::maxi<RealScalar>(maxDiagEntry, numext::maxi<RealScalar>(
