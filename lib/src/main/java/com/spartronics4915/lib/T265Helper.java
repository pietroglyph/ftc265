...
/**
 * This class makes it easy to use the T265 camera. Once you call {@link #getCamera(T265Camera.OdometryInfo, Context)},
 *  it generates a new camera object that is preserved between op modes. To destroy the camera, call
 *  {@link #destroyCamera()}.
 */
...
public class T265Helper {
     ...
     * @return the camera
     */
    public static T265Camera getCamera(T265Camera.OdometryInfo odometryInfo, String relocMapPath, Context appContext) {
        if (slamera == null) {
