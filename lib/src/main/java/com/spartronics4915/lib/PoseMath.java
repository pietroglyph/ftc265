...
public class PoseMath {
    ...
    public static Pose2d transformBy(Pose2d t, Pose2d b) {
        ...
        return new Pose2d(
                ...
                Math.atan2(
                        cos_t * sin_b + sin_t * cos_b,
                        cos_t * cos_b - sin_t * sin_b
                )
        );
    }
     ...
     * @param other The pose that is the origin of the new coordinate frame that the initial pose will be converted into.
